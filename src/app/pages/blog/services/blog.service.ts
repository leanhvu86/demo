...
export class BlogService {
  ...
  getListBlog(): Observable<Blog[]> {
    return this.http.get<Blog[]>(this.BASE_SERVER_URL + '/posts');
  }

  getBlog(id:number): Observable<any> {
    return this.http.get<Blog[]>(this.BASE_SERVER_URL+'/posts/' + id);
  }
  ...
  updateBlog(id:number, data:any): Observable<Blog[]> {
    return this.http.put<Blog[]>(this.BASE_SERVER_URL + '/posts/' + id, data);
  }

  createBlog(data: any): Observable<Blog[]> {
    return this.http.post<Blog[]>(this.BASE_SERVER_URL + '/posts/', data);
  }

  deleteBlog(id:number): Observable<Blog[]> {
    return this.http.delete<Blog[]>(this.BASE_SERVER_URL + '/posts/' + id);
  }
